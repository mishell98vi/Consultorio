...
//TEST OBTENER POR CODIGO
        ...
        try {
            ...
            System.out.println(nTratamiento.getDoctor().getCodigo()+ "    " + nTratamiento.getPaciente().getCodigo()+ "    " + nTratamiento.getDiagnostico()+ "    " + nTratamiento.getReceta()+ "    " + nTratamiento.getTratamiento());
        } catch (Exception e) {
        }
